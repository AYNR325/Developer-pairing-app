  ...
  return (
    <div className="h-screen bg-black text-white flex overflow-hidden">
      ...
      <div className={`w-full md:w-1/3 border-r border-[#8D2B7E]/20 flex flex-col ${
        ...
        {/* Header */}
        <div className="p-3 sm:p-4 border-b border-[#8D2B7E]/20">
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <h1 className="text-xl sm:text-2xl font-bold">Messages</h1>
            {unreadCount > 0 && (
              <span className="bg-[#8D2B7E] text-white px-2 py-1 rounded-full text-xs sm:text-sm">
                {unreadCount}
              </span>
            )}
          </div>
          ...
          <input
            ...
            className="w-full p-2 bg-gray-800/50 border border-gray-700/50 rounded-lg text-white placeholder-gray-400 focus:border-[#8D2B7E] focus:outline-none text-sm sm:text-base"
          />
        </div>
            ...
            filteredConversations.map((conversation) => {
              ...
              return (
                <div
                  ...
                  className={`p-3 sm:p-4 border-b border-gray-800/50 cursor-pointer hover:bg-gray-800/30 ${
                    isSelected ? 'bg-[#8D2B7E]/20 border-l-4 border-l-[#8D2B7E]' : ''
                  }`}
                >
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#8D2B7E] rounded-full flex items-center justify-center text-base sm:text-lg font-semibold flex-shrink-0">
      ...
      <div className={`flex-1 flex flex-col ${!showChatView ? 'hidden md:flex' : 'flex'}`}>
        {selectedConversation ? (
          <>
            ...
            <div className="p-3 sm:p-4 border-b border-[#8D2B7E]/20">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <button
                  ...
                  className="md:hidden w-8 h-8 flex items-center justify-center text-white hover:bg-gray-800 rounded-lg transition-colors mr-1"
                ...
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-[#8D2B7E] rounded-full flex items-center justify-center text-base sm:text-lg font-semibold flex-shrink-0">
            ...
            {/* Message Input */}
            <div className="border-t border-[#8D2B7E]/20 p-3 sm:p-4">
              <form onSubmit={sendMessage} className="flex gap-2 sm:gap-3">
                <div className="flex-1 relative">
                  <textarea
                    ...
                    className="w-full p-2 sm:p-3 bg-gray-800/50 border border-gray-700/50 rounded-xl text-white placeholder-gray-400 focus:border-[#8D2B7E] focus:outline-none resize-none text-sm sm:text-base"
                    rows="1"
                    style={{
                      minHeight: '40px',
                      maxHeight: '120px',
                ...
                <button
                  ...
                  className="px-4 sm:px-6 py-2 sm:py-3 bg-[#8D2B7E] text-white rounded-xl hover:bg-[#8D2B7E]/80 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-1 sm:gap-2 flex-shrink-0"
                >
          ...
          <div className="flex-1 flex items-center justify-center text-gray-400 hidden md:flex">
            <div className="text-center">
